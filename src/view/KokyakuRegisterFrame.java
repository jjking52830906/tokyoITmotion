...
public class KokyakuRegisterFrame extends JFrame implements ActionListener{
    ...
    public KokyakuRegisterFrame() {
        ...
        rbSex[0].setBounds(105, 148, 56, 21);
        rbSex[1].setBounds(183, 148, 56, 21);
        rbSex[2].setBounds(264, 148, 113, 21);
        ...
        lblTel.setBounds(12, 252, 50, 13);
        contentPane.add(lblTel);
        
        
        lblTelNote = new JLabel("※ハイフンなし");
        lblTelNote.setBounds(105, 278, 92, 13);
        contentPane.add(lblTelNote);
        
        
        txtTel = new JTextField();
        txtTel.setBounds(105, 249, 261, 19);
        contentPane.add(txtTel);
        txtTel.setColumns(10);
                
        Register = new JButton("登録");
        Register.setBounds(115, 315, 113, 41);
        contentPane.add(Register);
        Register.addActionListener(this);
        
        Return = new JButton("キャンセル");
        Return.setBounds(307, 314, 126, 43);
        contentPane.add(Return);
        
        JLabel lblNewLabel = new JLabel("年");
        lblNewLabel.setBounds(183, 98, 24, 13);
        contentPane.add(lblNewLabel);
        
        JLabel lblNewLabel_1 = new JLabel("月");
        lblNewLabel_1.setBounds(289, 98, 24, 13);
        contentPane.add(lblNewLabel_1);
        
        JLabel lblNewLabel_2 = new JLabel("日");
        lblNewLabel_2.setBounds(399, 98, 24, 13);
